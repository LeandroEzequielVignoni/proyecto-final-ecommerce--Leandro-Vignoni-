...
//         const cartActions = document.getElementById("cart-actions"); // Contenedor para las acciones del carrito
        

//         // Verifica si estamos en carrito.html
//         if (!cartDetails || !cartTotal) {
//             return;
//         }

//         // Limpia los detalles actuales
//         cartDetails.innerHTML = "";
//         if (cartActions) cartActions.innerHTML = ""; // Limpia las acciones previas
...
//         // Añade el botón de "Finalizar Compra"
//         if (cartActions) {
...
//             cartActions.appendChild(finalizeButton); // Añade el botón al contenedor
//         }
//     }
...
//     // Asigna eventos a los botones "Agregar al carrito" en productos.html
...
//     // Asigna el evento al botón "Vaciar Carrito" en carrito.html
...
//     // Renderiza el carrito si estamos en carrito.html
//     renderCart();
